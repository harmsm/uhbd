...
0.4.2: 060519
    Made output directory optional rather than required argument.
"""
...
if __name__ == "__main__":
    ...
    required, optional = argParser.main(sys.argv,["pdb_file"],
                                        ["inpfile"],
                                        ["dielectric","ionic_strength",
                                         "pHtitr","out_dir"])
    main(required["pdb_file"],optional.out_dir,optional.pHtitr[0],
